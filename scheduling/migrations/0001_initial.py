    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type",
                    models.CharField(choices=[("holiday", "Public Holiday"), ("impromptu", "Impromptu Closure"), ("event", "School Event")], max_length=20),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "mode",
                    models.CharField(
                        choices=[("cycle", "Rotating day cycle (Day 1 … Day N)"), ("weekday", "Regular weekly (Mon – Fri)")], default="weekday", max_length=10
                    ),
                ),
                ...
                (
                    "anchor_date",
                    models.DateField(
                        blank=True, help_text="The first school day on/after this date is Day 1. Usually the first day of the academic year.", null=True
                    ),
                ),
                ("updated_at", models.DateTimeField(auto_now=True)),
            ],
