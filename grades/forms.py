...
from .models import Evaluation, GradeVisibilityRule
...
class BulkGradeUploadForm(forms.Form):
    excel_file = forms.FileField(label="Excel File (.xlsx)", help_text="Download the template, fill in grades, then upload.")
